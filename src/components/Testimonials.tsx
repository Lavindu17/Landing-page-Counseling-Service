...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      quote: "Dr. Mitchell helped me navigate through one of the most difficult periods of my life. Her compassionate approach and practical tools made all the difference in my recovery.",
      name: "Sarah K.",
      outcome: "Overcame anxiety and depression after 6 months of therapy",
      rating: 5
    },
    {
      quote: "The relationship counseling sessions saved my marriage. We learned to communicate better and rediscovered our connection. I'm grateful for the guidance and support.",
      name: "Michael R.",
      outcome: "Improved relationship satisfaction and communication",
      rating: 5
    },
    {
      quote: "I was skeptical about therapy at first, but Dr. Mitchell created such a safe space. I finally felt heard and understood. The trauma therapy has been life-changing.",
      name: "Jennifer L.",
      outcome: "Successfully processed trauma and reduced PTSD symptoms",
      rating: 5
    },
    {
      quote: "The stress management techniques I learned have completely transformed how I handle work pressure. I feel more balanced and in control of my life.",
      name: "David C.",
